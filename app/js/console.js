    ...
    switch (command) {
      ...
      case "center":
        ...
        Console.messages.innerHTML +=
          "<div class='output'>Moved to center</div>";
        break;
      case "goto":
        let dx = 0;
        if (
        ...
        Console.messages.innerHTML +=
          "<div class='output'>Moved to " +
          Math.round(offset.x + dx) +
          " " +
          Math.round(offset.y + dy) +
          "</div>";
        scroll(dx, dy);
        break;
      case "find":
        ...
        if (component) {
          ...
          Console.messages.innerHTML +=
            "<div class='output'>No component called '" +
            args[0] +
            "' found</div>";
        break;
      case "connect":
        ...
        if (!from && !to) {
          Console.messages.innerHTML +=
            "<div class='output'>No components called '" +
            args[0] +
            "' and '" +
            args[1] +
            "' found</div>";
      ...
      case "list":
        ...
        Console.messages.innerHTML += "<div class='output'>" + list + "</div>";
        break;
      case "set":
